...
export default async function DashboardPage() {
  ...
  const [
    ...
    adminSupabase
      .from("trips")
      .select("id, display_id, origin_zone, destination_zone, cutoff_time, current_orders, max_orders, destination_lat, destination_lng, estimated_delivery_time, profiles(username)")
      .eq("status", "open")
