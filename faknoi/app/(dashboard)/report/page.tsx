...
export default function ReportPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // หา username ของ testtest เพื่อ insert report ไปหา
              ...
              <button key={val} type="button"
                ...
                className={`py-3 rounded-2xl text-sm font-black border-2 transition-all duration-150 ${
                  role === val
                    ...
                    : "border-gray-100 text-gray-500 bg-gray-50 hover:border-brand-blue/30"
                }`}
          ...
          <div onClick={() => fileRef.current?.click()}
            ...
            {preview ? (
              ...
              <>
                ...
                <p className="text-xs text-gray-400 text-center font-medium">แตะเพื่อเลือกรูป</p>
              </>
            )}
          </div>
