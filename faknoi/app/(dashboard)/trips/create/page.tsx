      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl px-4 py-3 flex items-start gap-3">
          ...
          <div className="text-xs text-amber-800 space-y-1">
            ...
            <p>การรับหิ้ว <span className="font-black">สินค้าผิดกฎหมาย สินค้าต้องห้าม หรือสิ่งผิดกฎหมายทุกประเภท</span> ถือเป็นความรับผิดชอบของผู้รับหิ้วโดยตรง FakNoi ขอสงวนสิทธิ์ระงับบัญชีและดำเนินการตามกฎหมายกับผู้ที่กระทำผิด</p>
          </div>
        </div>
